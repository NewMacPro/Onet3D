...
namespace Facebook.Unity.Editor
{
    ...
    public class FacebookSettingsEditor : UnityEditor.Editor
    {
        ...
        private bool showAndroidUtils;
        private bool showIOSSettings;
        ...
        private void Awake()
        {
            showAndroidUtils = EditorUserBuildSettings.activeBuildTarget == BuildTarget.Android;
            showIOSSettings = EditorUserBuildSettings.activeBuildTarget.ToString() == "iOS";
        }
